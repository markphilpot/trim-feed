  ...
  return (
    <>
      ...
      <h1 className="mt-14 font-display text-4xl/tight font-light text-white">
        Trim<br/>
        <span className="text-sky-300">Progenetor of a<br/>Yahoo Pipes Alternative</span>
      </h1>
      <p className="mt-4 text-sm/6 text-gray-300">
        A helpful tool for malformed RSS feeds
      </p>
      {/* <SignUpForm /> */}
      <div className="mt-8 flex flex-wrap justify-center gap-x-1 gap-y-3 sm:gap-x-2 lg:justify-start">
        ...
        <IconLink href="https://github.com/markphilpot/trim-feed" icon={GitHubIcon} className="flex-none">
          GitHub
        </IconLink>
...
export function IntroFooter() {
  return (
    <p className="flex items-baseline gap-x-2 text-[0.8125rem]/6 text-gray-500">
      Brought to you by{' '}
      <IconLink href="https://philpot.org/@mark" icon={MastodonIcon} compact large>
        Mark Philpot
      </IconLink>
    </p>
  )
